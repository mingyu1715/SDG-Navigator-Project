...
import {
  pickSdg01Scenario,
  getSdg01ScenarioView,
  renderSdg01ResourceItems
} from "./sdg01ContentModel.js";
...
export class Sdg01DetailContent {
  ...
  pickScenario(previousScenario) {
    return pickSdg01Scenario(previousScenario);
  }
  ...
  revealScenario(scenario) {
    ...
    const scenarioView = getSdg01ScenarioView(scenario);
    this.refs.targetReadout.textContent = scenarioView.targetReadout;
    this.refs.resultTitle.textContent = scenarioView.resultTitle;
    this.refs.resultSummary.textContent = scenarioView.resultSummary;
    this.refs.birthPlace.textContent = scenarioView.birthPlace;
    this.refs.regionNote.textContent = scenarioView.regionNote;
    this.refs.incomeTier.textContent = scenarioView.incomeTier;
    this.refs.incomeNote.textContent = scenarioView.incomeNote;
    this.refs.waterAccess.textContent = scenarioView.waterAccess;
    this.refs.waterNote.textContent = scenarioView.waterNote;
    this.refs.narrative.textContent = scenarioView.narrative;
